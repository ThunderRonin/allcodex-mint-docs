...
* **Layout**: The Portal colors nodes based on their `loreType` (e.g. gold for characters, blue for locations, purple for factions).
* **Details**: Click any node to open a preview panel that displays its description and primary attributes, letting you traverse your wiki.
