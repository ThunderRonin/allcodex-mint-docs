...
To retain proper nouns (such as character names, unique spells, or specific item titles) that vector approximations might miss, AllKnower queries AllCodex Core's SQLite Full-Text Search (FTS5) engine. This engine uses the **BM25 algorithm** to score notes by term frequency and inverse document frequency.
