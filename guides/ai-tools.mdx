...
* **Caching and deduplication**: To minimize token usage, AllKnower caches suggestions by content hash. Repeating a query on an unmodified note costs zero tokens. The system deduplicates in-flight requests to prevent parallel LLM calls.
